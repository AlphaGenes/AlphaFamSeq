        ...
        ALLOCATE(post(3,0:2*nAnis), &
	      ...
	      do WHILE (ifreq_iterate < nfreq_max -1)
	        ...
	        do i=1,nAnis ! M Battagin - removed use of the prior (i.e., AlleleFrequencies)
	          ant(1,i)=log(.000000001) ! log(0.5*0.5)   !log(qprior*qprior)     ! log(.000000001)! 
	          ant(2,i)=log(.000000001) !log(2*0.5*0.5) !log(2.0*pprior*qprior) ! log(.000000001)! 
	          ant(3,i)=log(.000000001) !log(0.5*0.5)   !log(pprior*pprior)     ! log(.000000001)!
	        enddo
